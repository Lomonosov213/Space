...
$(document).ready(function () {// для паралакса нужно в html добавить к li атрибут data-depth
   $('.parallax__list>li').addClass('layer');
   $('.parallax__list').parallax();//добавил паралакс эффект (файл нужно подключить в арр)
   $('.wrapper').addClass('_actives')// дабавил класс в котором буду настраивать плавность появления всего котента
});
...
function scroll_scroll() {
	...
	if (header !== null) {
		if (src_value > 50) {//когда появится блок (хедер)
